...
plt.tight_layout()
plt.savefig("results/diabetes_supervised_regressors_comparison.png") # Save the figure
plt.show()

# Command to run the script and save the terminal output
#python scripts/supervised/diabetes.py | tee results/diabetes_supervised_terminal_output.txt