...
plt.tight_layout()
plt.savefig("results/iris_supervised_regressors_comparison.png") # Save the figure
plt.show()

# Command to run the script and save the terminal output
#python scripts/supervised/iris.py | tee results/iris_supervised_terminal_output.txt